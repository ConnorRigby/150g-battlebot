...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, M2_EN_Pin|MC_RESET_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : M2_EN_Pin MC_RESET_Pin */
  GPIO_InitStruct.Pin = M2_EN_Pin|MC_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : M2_FAULT_Pin */
  GPIO_InitStruct.Pin = M2_FAULT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(M2_FAULT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : M1_FAULT_Pin */
